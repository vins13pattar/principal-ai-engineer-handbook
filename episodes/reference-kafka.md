# Kafka: The Log That Doesn't Forget

_Kafka's core trick — an append-only log where consumers, not the broker, own their position — explains both its superpowers (replay, multiple independent readers) and its sharpest gotchas (ordering scope, retention limits, and what 'exactly-once' really covers)._

- **Source:** [reference:kafka](/reference/lookups/kafka/)
- **Runtime:** 4:42 · 12 turns · 4 beats

# Module 8: RAG — Making Retrieval the Star of the Show

_RAG succeeds or fails on retrieval quality, not model cleverness — the episode walks through why two independent pipelines exist, how chunking/embedding/hybrid search/re-ranking decisions shape what the model ever sees, why freshness and access control are architectural decisions not afterthoughts, and why retrieval and generation must be measured as two separate systems._

- **Source:** [module:08-rag](/learn/modules/08-rag/)
- **Runtime:** 12:46 · 34 turns · 10 beats

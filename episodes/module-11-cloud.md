# Module 11: Cloud — Decisions You Can't Refactor Away

_Cloud architecture choices for AI infrastructure are expensive to reverse, so this episode walks through the four decisions that matter most — managed vs. self-hosted, blast radius, real (tested) recovery, and cost attribution — and shows why each one only counts when it's proven, not just diagrammed._

- **Source:** [module:11-cloud](/learn/modules/11-cloud/)
- **Runtime:** 11:07 · 34 turns · 10 beats

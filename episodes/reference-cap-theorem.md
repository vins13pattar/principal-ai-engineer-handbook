# CAP Theorem: The Choice You Only Face During a Partition

_CAP is a narrow, precise statement about behavior during a network partition — not a three-property menu — and understanding it correctly means knowing what it doesn't cover, seeing it made concrete in a real system, and clearing away the misconceptions that make it useless in a design discussion._

- **Source:** [reference:cap-theorem](/reference/lookups/cap-theorem/)
- **Runtime:** 5:13 · 11 turns · 3 beats

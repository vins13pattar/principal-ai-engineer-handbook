# ADR-0006: When Prettier Corrupts the Code It's Supposed to Format

_A formatter silently broke real Python examples inside MDX doc components, and the fix — excluding those files from Prettier entirely — trades cosmetic consistency for the guarantee that code stays code._

- **Source:** [adr:0006-exclude-content-mdx-from-prettier](/adr/decisions/0006-exclude-content-mdx-from-prettier/)
- **Runtime:** 5:08 · 11 turns · 3 beats

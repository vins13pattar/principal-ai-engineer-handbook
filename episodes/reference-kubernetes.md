# Kubernetes: The Reconciliation Layer Under Your GPUs

_Kubernetes never executes anything directly — it reconciles declared state toward observed state forever — and almost every AI-platform failure mode traces back to that loop misreading requests, limits, probes, or disruption budgets._

- **Source:** [reference:kubernetes](/reference/lookups/kubernetes/)
- **Runtime:** 6:05 · 15 turns · 4 beats

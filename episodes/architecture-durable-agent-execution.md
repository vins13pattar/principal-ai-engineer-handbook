# Durable Agent Execution: Building Systems That Survive Crashes

_Long-running, expensive agent work cannot live inside a synchronous request lifetime; the only honest guarantee is at-least-once delivery, and every architectural decision — leasing, fencing, checkpointing, dead-lettering — follows from taking that constraint seriously rather than pretending it away._

- **Source:** [architecture:durable-agent-execution](/architecture/systems/durable-agent-execution/)
- **Runtime:** 14:51 · 34 turns · 10 beats

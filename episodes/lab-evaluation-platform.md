# The Eval That Can Lie to You

_A fifty-example eval set doesn't just have noise — it has a specific, computable blind spot, and most teams never compute it before believing a scoreboard._

- **Source:** [lab:evaluation-platform](/build/labs/evaluation-platform/)
- **Runtime:** 4:59 · 12 turns · 3 beats

# Policy-Gated Tool Execution: Why a Model's Request Isn't an Authorization

_A tool call emitted by a model is just a request; turning it into a safe action requires a dedicated enforcement layer that answers five ordered questions, treats the model itself as untrustworthy, and is built to fail loudly rather than silently._

- **Source:** [architecture:policy-gated-tool-execution](/architecture/systems/policy-gated-tool-execution/)
- **Runtime:** 15:11 · 36 turns · 9 beats

# ADR-0003: Rendering Mermaid Diagrams for a Live Theme Toggle

_Because the docs site's dark-mode toggle can flip at any moment, Mermaid diagrams must be able to react live — which pushes rendering from build time into the browser, and shapes every detail of how the component is built._

- **Source:** [adr:0003-client-side-mermaid-rendering](/adr/decisions/0003-client-side-mermaid-rendering/)
- **Runtime:** 3:13 · 8 turns · 3 beats

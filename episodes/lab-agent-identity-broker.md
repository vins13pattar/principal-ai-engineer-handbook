# The Token That Can't Widen: Inside the Agent Identity Broker

_A credential exchange that narrows audience, scope, and lifetime together is a control; anything less is a design review passing on vibes — and the lab proves it by making its own tests fail._

- **Source:** [lab:agent-identity-broker](/build/labs/agent-identity-broker/)
- **Runtime:** 4:19 · 12 turns · 3 beats

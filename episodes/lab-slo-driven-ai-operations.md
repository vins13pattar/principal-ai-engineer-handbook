# SLO-Driven AI Operations: Making Reliability a Spendable, Actionable Signal

_An error budget is only useful when one severity computation drives alerting, autoscaling, and incident response together — this lab shows what that looks like as running code, from multiwindow burn-rate detection to an honest terminal state._

- **Source:** [lab:slo-driven-ai-operations](/build/labs/slo-driven-ai-operations/)
- **Runtime:** 4:31 · 12 turns · 3 beats

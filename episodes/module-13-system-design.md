# Module 13: System Design — From Underspecified Request to Falsifiable System

_System design is not choosing components — it is stating falsifiable, numeric claims about behavior, cost, and failure before any component is chosen, spending deliberation in proportion to how hard a decision is to undo. AI systems raise the stakes on every part of this because the model degrades without erroring, costs money per call, resists profiling, and returns different answers to identical inputs._

- **Source:** [module:13-system-design](/learn/modules/13-system-design/)
- **Runtime:** 20:32 · 55 turns · 12 beats

# Module 7: LangGraph — Turning Control Flow Into Data

_LangGraph doesn't replace Module 5's hand-rolled agent loop with something smarter — it re-expresses the same observe-decide-act shape as an explicit, typed graph, and that single shift (control flow becomes data) is what makes checkpointing, crash recovery, and human-in-the-loop approval fall out for free instead of requiring separate bespoke machinery._

- **Source:** [module:07-langgraph](/learn/modules/07-langgraph/)
- **Runtime:** 12:15 · 34 turns · 9 beats

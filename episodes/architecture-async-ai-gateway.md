# Async AI Gateway: Designing for Failure at the Edge of the LLM Provider

_A gateway sitting between applications and LLM providers must protect itself, the providers, and every tenant sharing them — which means every architectural decision, from request ordering to draining to fallback, is really a decision about how failure gets contained rather than propagated._

- **Source:** [architecture:async-ai-gateway](/architecture/systems/async-ai-gateway/)
- **Runtime:** 11:35 · 28 turns · 7 beats

# Cheat Sheet: Incident Response — Do This, In This Order

_When you've just been paged, the order of operations matters more than any single technique — stop the bleeding, name a lead, find what changed, and only then chase root cause, all while communicating on a fixed cadence._

- **Source:** [cheatsheet:incident-response](/cheatsheets/sheets/incident-response/)
- **Runtime:** 4:00 · 8 turns · 3 beats

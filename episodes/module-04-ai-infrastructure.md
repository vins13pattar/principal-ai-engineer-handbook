# Module 4: AI Infrastructure — The Layer Between Model and Product

_AI infrastructure is the discipline of treating model and provider choice as a fast-changing, non-deterministic dependency that needs the same engineering rigor as any other production system — routing, cost tracking, evaluation, and deploy discipline — rather than either raw ML research or generic backend plumbing._

- **Source:** [module:04-ai-infrastructure](/learn/modules/04-ai-infrastructure/)
- **Runtime:** 14:31 · 35 turns · 10 beats

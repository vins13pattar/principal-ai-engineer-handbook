# The Durable Agent Task Engine: Surviving Crashes Without a Supervisor

_At-least-once delivery is the only honest guarantee for long-running agent work, and every mechanism in this lab — leases, fencing, delivery-counted retries, checkpoints — exists to make that guarantee safe rather than merely tolerable._

- **Source:** [lab:durable-agent-task-engine](/build/labs/durable-agent-task-engine/)
- **Runtime:** 6:17 · 13 turns · 4 beats

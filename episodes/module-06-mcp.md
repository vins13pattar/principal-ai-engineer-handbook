# MCP: From Bespoke Integrations to a Stateless Protocol

_MCP standardizes how models connect to tools and data through a host/client/server split, and the 2026-07-28 revision's removal of session state is a case study in the classic stateful-to-stateless service migration, with real consequences for security, scaling, and where credentials belong._

- **Source:** [module:06-mcp](/learn/modules/06-mcp/)
- **Runtime:** 22:27 · 66 turns · 12 beats

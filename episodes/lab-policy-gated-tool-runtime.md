# Policy-Gated Tool Runtime: Enforcement Before Autonomy

_Letting a model decide to call a tool is not the same as authorizing that call — this lab shows the five-check pipeline that stands between a request and an action, why the order of those checks is load-bearing, and how it survives untouched even as the protocol wrapping it changes underneath._

- **Source:** [lab:policy-gated-tool-runtime](/build/labs/policy-gated-tool-runtime/)
- **Runtime:** 5:26 · 12 turns · 4 beats

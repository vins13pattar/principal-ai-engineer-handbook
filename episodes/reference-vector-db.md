# Vector DB: The Category Behind the Buzzword

_A vector DB isn't a product you can pin a version to — it's a category of ANN search systems whose real complexity lives in the concepts, the fixed-at-creation constraints, and the operational gotchas that vendor marketing glosses over._

- **Source:** [reference:vector-db](/reference/lookups/vector-db/)
- **Runtime:** 7:34 · 18 turns · 5 beats

# Redis: The Single-Threaded Trick Behind Distributed Correctness

_Redis looks like a simple in-memory cache, but its single-threaded design and atomic primitives are what let AI infrastructure keep per-replica state correct — as long as you respect what it does and doesn't guarantee about durability and consistency._

- **Source:** [reference:redis](/reference/lookups/redis/)
- **Runtime:** 6:00 · 15 turns · 4 beats

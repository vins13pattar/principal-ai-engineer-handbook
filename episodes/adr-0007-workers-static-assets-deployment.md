...
_When Cloudflare quietly moved new git-connected projects from Pages onto Workers Builds, the platform underneath ADR-0005's deployment decision shifted, forcing a re-decision that had to solve three silent failure modes at once while preserving the monorepo and the root-relative link scheme already paid for._

- **Source:** [adr:0007-workers-static-assets-deployment](/adr/decisions/0007-workers-static-assets-deployment/)
- **Runtime:** 5:02 · 13 turns · 4 beats

# The Router That Does the Math: Task-Based Model Routing

_A model router has to filter by capability before it ever thinks about cost, and even a well-built one can still be steered by the wrong metric — escalation looks like free savings until you measure cost per correct answer instead of cost per rescued answer, and the whole architecture is really about making that distinction explicit, ordered, and auditable._

- **Source:** [architecture:task-based-model-routing](/architecture/systems/task-based-model-routing/)
- **Runtime:** 14:34 · 38 turns · 11 beats

# The Metric That Lies: Model Router and the Escalation Trap

_Escalation—try cheap, fall back to expensive—sounds like free lunch, but the metric everyone reaches for to prove it works is exactly the one that hides its cost; Model Router builds the number that doesn't._

- **Source:** [lab:model-router](/build/labs/model-router/)
- **Runtime:** 4:23 · 10 turns · 3 beats

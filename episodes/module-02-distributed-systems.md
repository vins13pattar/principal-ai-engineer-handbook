# Module 2: Distributed Systems — The Network Is Not Your Function Call

_Distributed systems design isn't about eliminating the ambiguity a network introduces into every call — it's about building the five mechanisms (idempotency, explicit delivery semantics, per-invariant consistency, backpressure, and recovery) that let a system stay correct despite that ambiguity, and this episode walks the pattern from the mental model through working code and a real lab._

- **Source:** [module:02-distributed-systems](/learn/modules/02-distributed-systems/)
- **Runtime:** 17:30 · 47 turns · 12 beats

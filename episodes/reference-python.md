# Python: The Model Behind the Gotchas

_Python's convenience hides one specific execution model — a single-threaded bytecode interpreter with reference-counted, heap-allocated everything — and nearly every surprising bug or performance ceiling in a real service traces straight back to it._

- **Source:** [reference:python](/reference/lookups/python/)
- **Runtime:** 6:47 · 13 turns · 4 beats
